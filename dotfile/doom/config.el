...
(setq org-directory "/vagrant/org-note/")

;; This determines the style of line numbers in effect. If set to `nil', line
;; numbers are disabled. For relative line numbers, set this to `relative'.
(setq display-line-numbers-type t)

;; set C-i to jumper-forward
(map! :map (global-map c-mode-base-map)
      :n "TAB" #'better-jumper-jump-forward
...
;; doom meghanada jar install error https://github.com/hlissner/doom-emacs/issues/4979
